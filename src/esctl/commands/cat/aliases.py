...
@app.command(
    help="Get the cluster's index aliases, including filter and routing information. Doesn't return data stream aliases.",
    short_help="Get the cluster's index aliases.",
)
def aliases(
    ctx: typer.Context,
    ...
    name: Annotated[
        ...
        typer.Argument(
            ...
            help="Alias name(s) to filter the response",
        ),
    ] = "*",
