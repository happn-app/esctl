...
class KubeESConfig(ESConfig):
    ...
    def client(self) -> Elasticsearch:
        if not self.kube_namespace or not self.es_name or not self.kube_context:
            raise ValueError("kube_namespace, kube_context and es_name must be set for kubernetes contexts")
